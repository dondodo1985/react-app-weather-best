...
const Settings = () => {
	...
	const navigateToProject = () => {
		navigate("https://github.com/dondodo1985/react-app-weather-best");
	};

	const navigateToLinkedin = () => {
		navigate("https://www.linkedin.com/in/james-ragive-dominique-97b43738/");
	};

	const navigateToGithub = () => {
		navigate("https://github.com/dondodo1985");
	};
			...
			<section className="container-fluid width-toggle-5 m-auto">
				...
				<section className="support-developer d-flex align-items-start justify-content-center w-100 flex-column">
					...
					<section className="sponsor-me text-muted text-start w-100">
						...
						<p>
							Hi, I'm James Ragive Dominique. I built this weather app in 2023
							to sharpen my react skills and also have a clean, ads free
							application I can use. I make most of my side projects open source
							with the hope people would be able to learn and use the things I
							build.
						</p>
						...
						<section className="icon-section d-flex p-2">
							<svg
								...
								<path
									...
									fill={"rgb(83, 166, 250)"}></path>
							</svg>
							<p className=" text-capitalize px-3 text-dark">Contact me!</p>
						</section>
						<p>
							You can contact me on my Linkedin profile profile for suggestions
							or bugs.If you find the project interesting, please let me know.
						</p>
						<section className="d-md-flex align-items-center justify-content-center">
							<Button
