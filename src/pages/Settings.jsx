	...
	return (
		<React.Fragment>
			...
			<section className="container-fluid">
				...
				<section className="main-settings d-flex align-items-start justify-content-center w-100">
					<section className="settings">
						<form
							...
							<div className="mb-3 select-temp-unit">
								<select
							...
							<hr className="horizontal-line py-3 w-100 m-auto " />
							...
							<section className="form-check form-switch my-3">
								<input
									className="input-track form-check-input"
									type="checkbox"
									role="switch"
